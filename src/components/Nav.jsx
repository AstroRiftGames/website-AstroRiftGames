...
function Nav() {
  ...
  return (
    <>
      ...
      {/* Menú móvil */}
      <div
        className={`fixed top-0 left-0 h-full w-80 bg-gradient-to-b from-gray-900 via-gray-900 to-black shadow-2xl z-50 transform transition-transform duration-300 ease-in-out md:hidden ${
